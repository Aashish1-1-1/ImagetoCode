   ...
   return ( 
    <>
	 ...
	 {codebox?(
		  ...
		  <div className=" w-1/2  shadow-lg border-red-500 border-b-2 lg:border-b-0 lg:border-r-2 lg:px-5  py-10 lg:py-0">
		  <h1 className="text-white mb-2 font-bold">Original code:</h1>
		  <CodeBox code={code} language={language} showLineNumbers={true}  />
		  </div>
	 
		  {optimizability?(<div className="w-1/2 rounded-lg shadow-lg py-5 lg:py-0">
